...
load_dotenv(ROOT.parent / "vk-tire-bot" / ".env")
...
def main() -> int:
    ...
    if not chats:
        print("   Пока нет ни одной беседы.")
        print("   Добавьте сообщество в чат менеджеров и запустите скрипт снова.")
        return 2
