#!/usr/bin/env python3
"""Install Asterro 16мм усил user photo — white bg, face-right, no flip."""
...
TMP = ROOT / ".tmp-disk"
STEM = "asterro-16mm-usil-gruzovoy-nocolor"
SOURCE = Path(
    "/Users/arsenijberdnikov/.cursor/projects/Users-arsenijberdnikov-Documents/assets/"
    "image-7af414be-7ef3-46da-b20f-3d25a4f38a9d.png"
)
TW, TH = 900, 1200
FILL = 0.84
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "asterro-16mm-usil-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print("saved + .tmp-disk/asterro-16mm-usil-new.jpg")
