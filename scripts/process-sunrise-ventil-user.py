#!/usr/bin/env python3
"""Install Sunrise (вентиль снаружи) — black bg → white 900×1200, no flip."""
...
TMP = ROOT / ".tmp-disk"
STEM = "sunrise-ventil-snaruzhi-gruzovoy-nocolor"
SOURCE = Path(
    "/Users/arsenijberdnikov/.cursor/projects/Users-arsenijberdnikov-Documents/assets/"
    "image-20e93054-6505-402e-8817-0b8645346284.png"
)
TW, TH = 900, 1200
FILL = 0.84
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "sunrise-ventil-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print(f"thumb={thumb.stat().st_size}b")
    print("saved + .tmp-disk/sunrise-ventil-new.jpg")
