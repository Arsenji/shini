#!/usr/bin/env python3
"""Install shared inner-tube photo for all камеры (kamera-tube.jpg)."""
...
SOURCE = Path(
    ...
    "image-1549ba28-19f5-4b19-9fcf-1dbfee6c7a66.png"
)
TW, TH = 900, 1200
FILL = 0.84
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "kamera-tube-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print("saved + .tmp-disk/kamera-tube-new.jpg")
