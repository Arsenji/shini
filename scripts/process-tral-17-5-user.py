#!/usr/bin/env python3
"""Install Грузовой Трал 17.5 10 шпилек — black bg → white, face-right."""
...
TMP = ROOT / ".tmp-disk"
STEM = "gruzovoy-tral-17-5-10-shpilek-gruzovoy-nocolor"
SOURCE = Path(
    "/Users/arsenijberdnikov/.cursor/projects/Users-arsenijberdnikov-Documents/assets/"
    "image-38d3d3c1-a270-41a9-832d-e35de6277a40.png"
)
TW, TH = 900, 1200
FILL = 0.84
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "tral-17-5-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print("saved + .tmp-disk/tral-17-5-new.jpg")
