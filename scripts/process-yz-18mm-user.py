#!/usr/bin/env python3
"""Install YZ 18 мм — white bg, face-right, no flip."""
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "yz-18mm-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print("saved + .tmp-disk/yz-18mm-new.jpg")
