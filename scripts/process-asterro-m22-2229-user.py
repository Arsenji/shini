#!/usr/bin/env python3
"""Install Asterro M22 /2 (2229) — white bg, face-right, no flip."""
...
TMP = ROOT / ".tmp-disk"
STEM = "asterro-m22-2-2229-gruzovoy-nocolor"
SOURCE = Path(
    "/Users/arsenijberdnikov/.cursor/projects/Users-arsenijberdnikov-Documents/assets/"
    "image-410923b9-1f98-44cc-89a8-11ca24c19e34.png"
)
TW, TH = 900, 1200
FILL = 0.84
...
def save_outputs(canvas: Image.Image) -> None:
    ...
    canvas.save(TMP / "asterro-m22-2229-new.jpg", "JPEG", quality=90, optimize=True)
...
def main() -> None:
    ...
    print("saved + .tmp-disk/asterro-m22-2229-new.jpg")
